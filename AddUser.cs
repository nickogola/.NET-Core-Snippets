...
namespace [custom]
{
    ...
    The architecture of most applications use a Domain Driven Approach which aggregates dependent classes or modules of similar functionality together
    I use nuget packages such as MediatR to route calls between the Controller and this domain class and FluentValidation to validate input
    Besides the 2 mentioned, I also have custom nuget package [custom].AspNetCoe nuget pkg that I inject the same way accross multiple projects
    ...
    */
    public class AddUser
    {
        ...
        {
            private readonly IAppDbContext _context; //AppDbContext is a wrapper aroun the Dapper calls to the db. I use this across , multiple projects to transact with the app database(s)
